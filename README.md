...
目的は、人物参照 core 候補の画像を、GIMP で確認済みの軽いノイズ除去とアンシャープマスクを使って整えつつ、**本人性を崩さずに** SwinIR で高解像度化することです。
...
- GIMP 未導入でも、GIMP 前処理 / 後処理を OFF にすれば **SwinIR 単体処理**はできます
...
- `元名_swinir_x2.png`
- GIMP 前処理を使う場合は `_gimp_pre`
- GIMP 後処理を使う場合は `_gimp_post`
- 人物切り抜きを使う場合は `_cutout`

例:

- `sample_swinir_x2_gimp_pre.png`
- `sample_swinir_x4_gimp_pre_gimp_post_cutout.png`
